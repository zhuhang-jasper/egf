...
export const DOC_TEXT = {
  body: "text-[12px] sm:text-[13px] md:text-[14px] leading-snug text-slate-500",
  bodyMedium: "text-[12px] sm:text-[13px] md:text-[14px] font-medium leading-snug text-slate-600",
  bodySemibold: "text-[12px] sm:text-[13px] md:text-[14px] font-semibold leading-snug text-slate-800",
