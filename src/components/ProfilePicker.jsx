    ...
    <div ref={rootRef} className="relative shrink-0">
      ...
      {open && (
        <div
          ...
          className="absolute right-0 top-[calc(100%+4px)] z-50 max-h-60 w-max max-w-[calc(100vw-2rem)] overflow-auto rounded-lg border border-border bg-card py-1 shadow-md sm:max-w-[280px]"
        >
          {profiles.length === 0 ? (
