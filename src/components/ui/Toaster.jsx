 ...
 * stack and renders a bottom-centered pile of transient notices. Toasts are added via the
 * store's `showToast` action and auto-dismiss on a timer (see useAppStore).
 */
export function Toaster() {
  ...
  return (
    <div aria-live="polite" aria-atomic="false" className="pointer-events-none fixed inset-x-0 top-4 z-[100] flex flex-col items-center gap-2 px-4">
      {toasts.map((t) => {
