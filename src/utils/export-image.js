...
//
// "Inter Display Canvas" is the opsz-pinned face the chart export's title is drawn in (declared in index.css).
...
// The 500 is the CHART EXPORT'S CREDIT LINE, which is canvas-painted: an unloaded weight there does not merely
